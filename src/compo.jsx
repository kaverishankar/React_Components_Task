                  ...
                  <div className="con">
                    {
                        ...
                        mixeddata.map((value) =>(
                            <div className="con" key={value.head} style={{display: 'flex',
                                flexWrap: 'wrap'}}>
                            {
  value.index % 2 !== 0 ? (
    <div className="con" key={value.head} style={{display: 'flex',
    ...
    <div style={{ padding: '50px', width: '710px', height: '300px' }}>
      ...
      <div style={{ width: '700px', height: '320px' }}>
        <img style={{ height: '400px', width: '800px' }} src={value.image} alt="image" />
      </div>
      </div>
    ...
    <div style={{ width: '710px', height: '300px' }}>
        <img style={{ height: '300px', width: '700px' }} src={value.image} alt="image" />
        </div>
      <div style={{ width: '700px', height: '320px' }}>
      <h1>{value.head}</h1>
      <h3>{value.subj}</h3>
